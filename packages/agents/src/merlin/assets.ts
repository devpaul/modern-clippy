...
export const mp3: SoundPack = {
	...
	'21': require('./assets/21.mp3'),
	'22': require('./assets/22.mp3'),
	'23': require('./assets/23.mp3'),
	'24': require('./assets/24.mp3'),
	'25': require('./assets/25.mp3'),
	'26': require('./assets/26.mp3'),
	'27': require('./assets/27.mp3'),
	'28': require('./assets/28.mp3'),
	'29': require('./assets/29.mp3'),
	'30': require('./assets/30.mp3'),
	'31': require('./assets/31.mp3'),
	'32': require('./assets/32.mp3')
};

const characterMap: string = require('./assets/map.png');
